<template>
  <el-row class="dc-container" v-loading="loading">
    ...
    >
      <el-row>
        <el-col :span="6">
          <el-form-item prop="actionType" label="操作类型" class="dc-el-form-item_SelectInput">
            <el-select
              v-model="queryFormData.actionType"
              :style="{ width: '100%' }"
              placeholder="请选择操作类型"
              clearable
              value-key="value"
            ...
            >
              <el-option v-for="(item, index) in actionTypeOptions" :key="index" :label="item.name" :value="item"></el-option>
            </el-select>
          </el-form-item>
        </el-col>
        <el-col :span="6">
          <el-form-item prop="objectName" label="对象名称" class="dc-el-form-item_SingleInput">
            <el-input
              v-model="queryFormData.objectName"
              :maxLength="128"
              placeholder="请输入对象名称"
              clearable
        ...
        <el-col :span="6">
          <el-form-item prop="createBy" label="操作者" class="dc-el-form-item_SingleInput">
            <el-input
        ...
        <el-col :span="8">
          <el-form-item prop="createDate" label="操作时间" class="dc-el-form-item_PickerTimeDateRange">
            <el-date-picker
...
import { listActionPage, deleteAction } from '@/api/sys/action'
    ...
    getList() {
      ...
      if (this.isQueryConditionPanel) {
        ...
        this.search.params.push({
          ...
          value: !validatenull(this.queryFormData.actionType.value) ? this.queryFormData.actionType.value : null
        })
        ...
        this.search.params.push({
          ...
          value: !validatenull(this.queryFormData.objectName) ? this.queryFormData.objectName : null
        })
    ...
    async pageInit() {
      ...
      try {
        ...
        if (listActionRespData.code == 100 && listPermissionRespData.code == 100) {
          this.tableDataTotal = listActionRespData.data.total
          this.tableData = listActionRespData.data.rows ? listActionRespData.data.rows : []
