    ...
    <el-container direction="horizontal" class="dc-el-container_ElContainer">
      ...
      <el-main>
        <el-row>
          ...
          >
            <ux-table-column
              field="applicationVersion.app.name"
...
import { listTenantAppPage, deleteTenantApp ,remoteList} from '@/api/ten/tenantApp'
...
export default {
  ...
  data() {
    return {
      ...
      searchList: [],
      tableId: '1391465689041903620',
      schemeId: '1391465689041903618'
    }
  },
  computed: {},
  methods: {
