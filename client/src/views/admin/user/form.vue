          ...
          <el-row>
            ...
            <el-col :span="12">
              <el-form-item
                prop="wechat"
                label="企业微信账号"
                :rules="[{ required: true, message: '企业微信账号不能为空', trigger: 'blur' }]"
                class="dc-el-form-item_SingleInput"
              >
                <el-input
  ...
  mounted: function () {
    this.$nextTick(() => {
      ...
      this.$on('openAddDialog', function (parent) {
        ...
        this.editFormData.tenant = parent.company.tenant
        this.editFormData.userRoleList = [{id: '', role: {id: "2032", name: '普通员工'}}] // 默认角色为普通员工
        this.initOptions(this.editFormData)
        this.tabName = 'editForm'
        this.dialogProps.visible = true
      })
