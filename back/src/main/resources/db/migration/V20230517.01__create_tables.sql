...
CREATE TABLE org_company_admin
(
	-- 标识
	id bigint(21) unsigned NOT NULL COMMENT '标识',
	-- 公司
...
(
	...
	-- 企业微信标识
	qy_open_id varchar(100) COMMENT '企业微信标识',
	-- 企业微信账号
	wechat varchar(100) COMMENT '企业微信账号',
	-- 备注信息
	remarks varchar(255) COMMENT '备注信息',
	-- 创建者
	create_by varchar(64) NOT NULL COMMENT '创建者',
...
CREATE INDEX idx_user_open_id ON sys_user (qy_open_id ASC);
