...
public class UserRoleController extends BaseController {
    ...
    public ResponseEntity<JSONObject> bulkInsert(@RequestBody List<UserRole> entitys) {
        List<String> ids = userRoleService.bulkInsert(entitys);
        return ResponseEntity.ok(ResultUtil.successJson(ids));
    }

    @PostMapping(value = "bulkUpdate")
    public ResponseEntity<JSONObject> bulkUpdate(@RequestBody List<UserRole> entitys) {
        List<String> ids = userRoleService.bulkUpdate(entitys);
        return ResponseEntity.ok(ResultUtil.successJson(ids));
    }

    @PostMapping(value = "bulkDelete")
    public ResponseEntity<JSONObject> bulkDelete(@RequestBody List<UserRole> entitys) {
