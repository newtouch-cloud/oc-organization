...
public class ShiroConfiguration {
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean(SecurityManager securityManager, JwtUtils jwtUtils) {
        ...
        filterChainDefinitionMap.put("/auth/authLogin", "anon");
        ...
        filterChainDefinitionMap.put("/ten/tenantApp/listAll", "anon");
        filterChainDefinitionMap.put("/ten/tenant/listAll", "anon");
